...
class PlanExercise(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
    plan_id: Mapped[int] = mapped_column(ForeignKey("workout_plans.id"), nullable=False)
    ...
    sets: Mapped[list["PlanSet"]] = relationship(
        back_populates="plan_exercise", cascade="all, delete-orphan"
    )
...
class PlanSet(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
    plan_exercise_id: Mapped[int] = mapped_column(ForeignKey("plan_exercises.id"), nullable=False)
...
class WorkoutSet(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
    workout_session_id: Mapped[int] = mapped_column(ForeignKey("workout_sessions.id"), nullable=False)
    exercise_id: Mapped[int] = mapped_column(ForeignKey("exercises.id"), nullable=False)
    ...
    workout_session: Mapped["WorkoutSession"] = relationship(back_populates="workout_sets")
